...
func NewServer(port string) (*Server, error) {
	...
	// Idle policy scheduler automatically initialized and started by AWS Manager (Issue #288)
	// No additional initialization needed - scheduler is ready in NewManager()
