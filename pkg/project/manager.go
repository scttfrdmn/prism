...
// Budget forecasting is derived from the budgetengine spend ledger in the daemon layer (Phase 3e,
// #655) — see pkg/daemon/forecast.go. The Manager owns project identity/lifecycle only and stays
// ledger-free; the pure, history-driven BudgetPredictor (pkg/project/predictor.go) is reused there.
