...
- Simplified navigation (14 items → 6 primary categories)
- "Instances" renamed to "Workspaces" (clearer terminology)
- CLI onboarding wizard (`cws init`)
- Collapsed advanced features under Settings
...
- SSM File Operations Support (template provisioning with large files)
- S3-backed file transfer with progress reporting
- Template asset management for binaries and configuration files
