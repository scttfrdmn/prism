// Package main provides GUI application for CloudWorkstation with embedded access handlers
package main
...
func (s *CloudWorkstationService) createTerminalCommand(sshCommand string) (*exec.Cmd, error) {
	switch runtime.GOOS {
	case osDarwin:
...
func (s *CloudWorkstationService) createMacOSTerminalCommand(sshCommand string) *exec.Cmd {
...
func (s *CloudWorkstationService) createWindowsTerminalCommand(sshCommand string) *exec.Cmd {
...
func (s *CloudWorkstationService) createLinuxTerminalCommand(sshCommand string) (*exec.Cmd, error) {
...
func (s *CloudWorkstationService) createLinuxTerminalCommandForEmulator(term, sshCommand string) *exec.Cmd {
	switch term {
	case "gnome-terminal":
