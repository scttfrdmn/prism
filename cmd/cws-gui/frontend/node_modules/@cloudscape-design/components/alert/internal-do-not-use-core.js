...
const Alert = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(InternalAlert, Object.assign({ type: type, visible: visible }, props, baseComponentProps, { __internalRootRef: __internalRootRef, ref: ref, messageSlotId: messageSlotId, style: style }, getAnalyticsMetadataAttribute({ component: componentAnalyticsMetadata }))));
});
