...
describe('CloudWorkstation App', () => {
  ...
  describe('Launch Modal', () => {
    ...
    it('launches instance successfully', async () => {
      ...
      expect(mockWails.CloudWorkstationService.LaunchInstance).toHaveBeenCalledWith(
        'test-instance',
  ...
  describe('Error Handling', () => {
    it('handles template loading errors gracefully', async () => {
      mockWails.CloudWorkstationService.GetTemplates.mockRejectedValue(new Error('Network error'));
    ...
    it('handles instance launch errors gracefully', async () => {
      mockWails.CloudWorkstationService.LaunchInstance.mockRejectedValue(new Error('Launch failed'));
