...
.awsui_root_brdst_df9ia_145:not(#\9) {
  /* used in test utils */
}

.awsui_loading_brdst_df9ia_149:not(#\9) {
  /* used in test utils */
}

.awsui_undo-button_brdst_df9ia_153:not(#\9) {
...
.awsui-motion-disabled .awsui_undo-button_brdst_df9ia_153:not(#\9), .awsui-mode-entering .awsui_undo-button_brdst_df9ia_153:not(#\9) {
  animation: none;
  transition: none;
}
.awsui_undo-button_brdst_df9ia_153:not(#\9):hover {
  cursor: pointer;
  color: var(--awsui-style-color-hover-vl73au, var(--color-text-link-hover-sq1gxg, #002b66));
}
.awsui_undo-button_brdst_df9ia_153:not(#\9):focus {
  outline: none;
}
.awsui_undo-button_brdst_df9ia_153:not(#\9):active {
  color: var(--awsui-style-color-active-vl73au, var(--color-text-link-hover-sq1gxg, #002b66));
}
.awsui_undo-button_brdst_df9ia_153:not(#\9):active, .awsui_undo-button_brdst_df9ia_153:not(#\9):focus, .awsui_undo-button_brdst_df9ia_153:not(#\9):hover {
  text-decoration-line: underline;
  text-decoration-color: var(--color-text-link-button-underline-hover-cn3mqh, transparent);
}
body[data-awsui-focus-visible=true] .awsui_undo-button_brdst_df9ia_153:not(#\9):focus {
  outline: thin dotted;
