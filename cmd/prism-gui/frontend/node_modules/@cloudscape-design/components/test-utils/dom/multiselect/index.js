...
const styles_selectors_js_7 = require("../../../token-group/styles.selectors.js");
class MultiselectWrapper extends dropdown_host_1.default {
    ...
    findToken(tokenIndex) {
        const tokenGroup = this.findComponent(`.${styles_selectors_js_7.default.root}`, token_group_1.default);
