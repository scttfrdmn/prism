...
.awsui_resize-active_x7peu_m370p_145:not(#\9):not(.awsui_resize-active-with-focus_x7peu_m370p_145) * {
  cursor: col-resize;
  -webkit-user-select: none;
          user-select: none;
}

th:not(#\9):not(:last-child) > .awsui_divider_x7peu_m370p_150,
.awsui_divider-interactive_x7peu_m370p_151:not(#\9) {
  position: absolute;
  outline: none;
  pointer-events: none;
  inset-inline-end: 0;
...
th:not(#\9):not(:last-child) > .awsui_divider-disabled_x7peu_m370p_165,
.awsui_divider-interactive-disabled_x7peu_m370p_166:not(#\9) {
  border-inline-start-color: var(--color-border-divider-default-nr68jt, #c6c6cd);
}
th:not(#\9):not(:last-child) > .awsui_divider-active_x7peu_m370p_169,
.awsui_divider-interactive-active_x7peu_m370p_170:not(#\9) {
  border-inline-start: 2px solid var(--color-border-divider-active-biq3j4, #0f141a);
}

th:not(#\9):last-child > .awsui_divider-interactive_x7peu_m370p_151:not(.awsui_is-visual-refresh_x7peu_m370p_174) {
  inset-inline-end: calc(var(--space-xl-jfy3x4, 24px) / 2);
}

.awsui_resizer_x7peu_m370p_178:not(#\9) {
...
.awsui_resizer_x7peu_m370p_178:not(#\9):focus {
  outline: none;
  text-decoration: none;
}
.awsui_resize-active_x7peu_m370p_145 .awsui_resizer_x7peu_m370p_178:not(#\9) {
  pointer-events: none;
}
.awsui_resizer_x7peu_m370p_178:not(#\9):hover + .awsui_divider_x7peu_m370p_150 {
  border-inline-start: 2px solid var(--color-border-divider-active-biq3j4, #0f141a);
}
body[data-awsui-focus-visible=true] .awsui_resizer_x7peu_m370p_178.awsui_has-focus_x7peu_m370p_228:not(#\9) {
  position: relative;
}
body[data-awsui-focus-visible=true] .awsui_resizer_x7peu_m370p_178.awsui_has-focus_x7peu_m370p_228:not(#\9) {
...
body[data-awsui-focus-visible=true] .awsui_resizer_x7peu_m370p_178.awsui_has-focus_x7peu_m370p_228:not(#\9)::before {
  content: " ";
  display: block;
  position: absolute;
...
th:not(#\9):last-child > .awsui_resizer_x7peu_m370p_178:not(.awsui_is-visual-refresh_x7peu_m370p_174) {
  inset-inline-end: 0;
}

.awsui_tracker_x7peu_m370p_257:not(#\9) {
  display: none;
  position: absolute;
...
.awsui_resize-active_x7peu_m370p_145 .awsui_tracker_x7peu_m370p_257:not(#\9) {
  display: block;
}